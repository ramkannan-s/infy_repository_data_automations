...
### Get Arguments
JPD_URL="${1:?please enter JPD URL. ex - http://35.208.78.203:8082}"
...
AUTH_TOKEN="${4:?please provide auth bearer token . ex - access token}"
...
### sample cmd to run - ./getProjectComponentList.sh https://ramkannans-sbx.dev.gcp.devopsacc.team source users/groups/roles ****